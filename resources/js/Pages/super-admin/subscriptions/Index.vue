...
const deleteRecord = (slug) => {
    if (confirm("Are you sure you want to delete this record?")) {
        const fullLink = "subscriptions/" + slug;
...
const columns = [
    'user_name', 'plan_name', 'gateway', 'payment_method_id', 'status', 'trial_ends_at', 'ends_at'

];

const colNames = [
    'user', 'plan', 'gateway', 'payment method', 'status', 'trial ends at', 'ends at'
