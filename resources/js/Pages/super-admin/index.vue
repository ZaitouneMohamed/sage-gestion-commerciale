                    ...
                    <form class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
                        <article class="mb-5">
                            ...
                            <p class="mb-2 text-gray-900 dark:text-white">
                                ...
                                everyone involved in the design project. Let me know about your availability in the
                                thread.
                            </p>
                        ...
                        <article class="mb-5">
                            ...
                            <p class="mb-2 text-gray-900 dark:text-white">
                                ...
                                working on this new project with you guys. But first things first, I'am waiting for the
                                offer and pitch deck from you. It would be great to get it by the end o the month.
                            </p>
                        ...
                        <article class="mb-5">
                            ...
                            <div class="items-center 2xl:space-x-4 2xl:flex">
                                ...
                                <div
                                    ...
                                    <div class="mr-4">
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white">bergside_pitch"
                                        </p>
                        ...
                        <div class="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
                            <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800" data-carousel-item>
                                ...
                                <p class="mb-4 text-gray-500 dark:text-gray-400">Get started with a free and open-source
                                    admin dashboard layout built with Tailwind CSS and Flowbite featuring charts,
                                    widgets, CRUD layouts, authentication pages, and more</p>
                            ...
                            <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800" data-carousel-item>
                                ...
                                <p class="mb-4 text-gray-500 dark:text-gray-400">Marketing, sales & business growth for
                                    small business. Improve your marketing & promotion results - and grow your sales!
                                </p>
